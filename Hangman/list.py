...
def main1():
    ...
    global cont1
    cont1 = continue_game()
    update_leaderboard(user, "Friend Zone ACHIEVED")
...
def main2():
    ...
    update_leaderboard(user, "Couple ACHIEVED")
...
def main3():
    ...
    update_leaderboard(user, "Marriage ACHIEVED")
...
def main4():
    ...
    guess_word4(word4)
    update_leaderboard(user, "R.I.P ACHIEVED")
